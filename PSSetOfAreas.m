...
- (void)addArea:(PSArea*) anArea{
    [super addObject:anArea ofName:[anArea name]];
}
...
- (PSArea*) addAreaOfName:(NSString*)aName{
    ...
    [super addObject:area ofName:aName];
    return area;
}
...
- (PSArea*) removeAreaOfName:(NSString*)aName{
    PSArea* area = [super removeObjectOfName:aName];
    return area;
}
...
- (PSArea*)removeArea:(PSArea*) anArea{
    return [super removeObject:anArea ofName:[anArea name]];
}
...
- (BOOL)containsArea:(PSArea *)anArea{
    return [super containsObject:anArea ofName:[anArea name]];
}
